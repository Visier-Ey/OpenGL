...
int width, height;
float aspect;
glm::mat4 pMat, vMat, mMat, mvMat, tMat, rMat, cameraRotateMat;
...
{
    renderingProgram = Utils::createShaderProgram("GLSL/vs.glsl", "GLSL/fs.glsl");
    renderingProgramCubeMap = Utils::createShaderProgram("GLSL/vsC.glsl", "GLSL/fsC.glsl");
    cameraX = 0.0f;
    cameraY = 0.0f;
    cameraZ = 8.0f;
    sphLocX = 0.0f;

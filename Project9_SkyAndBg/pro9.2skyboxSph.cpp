...
void init(GLFWwindow *window)
{
    ...
    setupVertices();
    skyboxTexture = Utils::loadTexture("Textures/skybox.jpg");
    // create perspective matrix
    glfwGetFramebufferSize(window, &width, &height);
    aspect = (float)width / (float)height;
    pMat = glm::perspective(toRadians(120), aspect, 0.1f, 1000.0f);
}
...
void display(GLFWwindow *window, double currentTime)
{
    ...
    useSkyboxLoc = glGetUniformLocation(renderingProgram, "useTexture");
    ...
    mvMat = vMat * glm::rotate(mMat,(float)currentTime*0.03f, glm::vec3(0.0f, 1.0f, 0.0f));
    ...
    // TODO : Skybox
    glUniform1i(useSkyboxLoc, GL_TRUE);
    ...
    // TODO : Shader
    glUniform1f(useSkyboxLoc, GL_FALSE);
